package com.xworkz.shopping.shoping;
...
public class ShopingMart {
    ...
    int index;
    int id=1;
    public ShopingMart(int size){
        product=new ProductDetails[size];

    }

    public boolean addProducts(ProductDetails product){
    ...
    public ProductDetails getProductsById(int id){
    ...
    public ProductDetails getProductByType(String type){
